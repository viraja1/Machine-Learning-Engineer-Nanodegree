...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon -= 0.05
            self.step += 1
            self.epsilon = pow(0.99, self.step)
    ...
    def choose_action(self, state):
        ...
        action_index = int(round(random.random() * 3))
        ...
        if self.learning:
            if self.epsilon > random.random():
                ...
                for a, value in self.Q[state].iteritems():
                    if value == max_q:
                        matched_actions.append(a)
                action = random.choice(matched_actions)
    ...
    def learn(self, state, action, reward):
        ...
        if self.learning:
            ...
            self.Q[state][action] = reward * self.alpha + (1 - self.alpha) * current_q
